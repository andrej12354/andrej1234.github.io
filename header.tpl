...
<html{$HTMLCLASS}{$HTMLLANG}{$HTMLRTL}>
    ...
    <head>
        ...
        <script>
            var ip_mc = 'hypixel.net' // minecraft server ip that will display on header
            var ip_discord = 'discord.gg/hypixel' // discord invite link that will display on header
